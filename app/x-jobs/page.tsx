...
function XJobsContent() {
  ...
  usePageReset(() => {
    console.log('[XJobs] Resetting page state on unmount');
  });
    ...
    <>
      ...
      <main className="flex-1 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="mb-6">
            <h1 className="text-2xl font-bold mb-2">X Campaigns</h1>
            <p className="text-muted-foreground">
              View and manage all X (Twitter) scraping Campaigns
            </p>
          </div>
          
          <JobListByPlatform platform="x" />
